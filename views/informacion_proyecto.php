...
<body class="d-flex flex-column h-100">
    ...
    <div class="container container-fluid d-flex justify-content-evenly contenedor-botones">
        ...
        <a href="materiales.php?id=<?php echo $idInspeccion; ?>" class="btn btn-dark mb-2">Ver Lista de Materiales</a>
        ...
        if ($num_materiales > 0) {
            echo '<a href="generar_pdf.php?id=' . $idInspeccion . '&nombre_proyecto=' . urlencode($proyecto["nombre_inspeccion"]) . '" class="btn btn-danger mb-2" target="_blank">Generar PDF</a>';
